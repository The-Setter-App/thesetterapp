  ...
  if (isPending) {
    return (
      <div className="flex items-start justify-start">
        <span className="thinking-shine px-4 text-sm font-medium">
          Thinking
        </span>
      </div>
    );
      ...
      <div className="max-w-[92%] px-4 text-sm leading-6 text-[#101011] md:max-w-[78%] md:text-[15px]">
        <ReactMarkdown
          ...
          components={{
            ...
            h2: ({ children }) => (
              <h2 className="mb-2 text-[15px] font-semibold md:text-base">
                {children}
              </h2>
            ),
            h3: ({ children }) => (
              <h3 className="mb-2 text-sm font-semibold md:text-[15px]">
                {children}
              </h3>
            ),
            p: ({ children }) => (
            ...
            blockquote: ({ children }) => (
              <blockquote className="mb-2 border-l-2 border-[#CFC6FF] pl-3 text-[#4D4F55]">
                {children}
              </blockquote>
            ),
            a: ({ children, href }) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[#6d5ed6] underline underline-offset-2"
              >
                {children}
              </a>
            ),
            ...
            thead: ({ children }) => (
              <thead className="bg-[#F8F7FF] text-[#4D4F55]">{children}</thead>
            ),
            th: ({ children }) => (
              <th className="border-b border-[#E6E1FF] px-3 py-2 font-semibold">
                {children}
              </th>
            ),
            td: ({ children }) => (
              <td className="border-b border-[#EEE9FF] px-3 py-2 align-top">
                {children}
              </td>
            ),
