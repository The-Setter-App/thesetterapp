                ...
                {days.map((day) => {
                    ...
                    return (
                        <button
                            ...
                            className={`group flex flex-col border-b border-r border-[#F0F2F6] p-1.5 text-left transition-colors hover:bg-[#FAFAFE] md:p-2 ${isCurrentMonth ? "bg-white" : "bg-[#FAFBFD]"
                                }`}
                        >
                            <span
                                className={`mb-1 inline-flex h-6 w-6 items-center justify-center rounded-full text-xs font-semibold transition-colors md:h-7 md:w-7 md:text-sm ${dayIsToday
